...
*** ivy                                                               :disabled:
:PROPERTIES:
:ID:       ce0570e1-7c5e-499f-97c3-a66233d2fe80
:END:
...
**** utilities
:PROPERTIES:
:ID:       7c8cf72d-6429-438c-bb2c-31efb3327b9a
:END:
...
***** swiper
:PROPERTIES:
:ID:       dc63f51f-9675-4784-95d2-a25e35edad47
:END:
...
the buffer. If a recentf path is selected, find the file of the recentf path."
  (interactive)
  (let* ((other-buffers (--reject (s-prefix-p " " (buffer-name it)) (cdr (buffer-list))))
...
#+begin_src emacs-lisp
(defadvice! properly-unfold-surrounding-headlines (:around void/goto-line void/jump-to-headline)
...
Feebleline is a replaces the typical emacs modeline with text printed out to
echo area.

The problem with the typical emacs modeline is that it appears in every buffer.
Better is a global modeline that displays the information from the buffer
...
(use-package! feebleline
  ...
  :config
  (defun feebleline:msg-display-mdy ()
    (format-time-string "%m:%d:%Y"))
  (defun feebleline:msg-display-mhs ()
  ...
  (setq feebleline-msg-functions
        '((feebleline-line-number :post "" :fmt "%5s")
          ...
          (feebleline:msg-display-mhs :align right)
          (feebleline:msg-display-mdy :align right))))
#+end_src
...
*** editing source block
:PROPERTIES:
:ID:       9f24cf0e-4510-4848-84f6-8872757b8972
:END:
...
*** exiting source block
:PROPERTIES:
:ID:       cfeb4ae6-a957-4dff-82f6-0b1d92d95b89
:END:
...
(define-leader-key!
  ...
  "l" (list :def #'elfeed                    :wk "elfeed")
  "d" (list :def #'deer                      :wk "deer")
  "r" (list :def #'ranger                    :wk "ranger")
  "e" (list :def #'void/open-emacs-instance  :wk "emacs")
  "q" (list :def #'search-web/default-engine :wk "browse web")
  "j" (list :def #'org/avy-jump-to-heading :wk "heading jump")
