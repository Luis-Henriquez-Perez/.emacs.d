...
#+begin_src emacs-lisp
(void-autoload '(ace-window ace-swap-window))
#+end_src
...
#+begin_src emacs-lisp
(void-autoload '(transpose-frame flip-frame flop-frame rotate-frame rotate-frame-clockwise)
               'transpose-frame)
#+end_src
...
(void-system-ensure 'ytel '(youtube-dl curl))
#+end_src
...
#+begin_src emacs-lisp
(defun void-autoload-commands (package commands)
  "Autoload COMMANDS for package."
  (--each commands
    (unless (foundp it)
      (autoload it (symbol-name package)))))

(defun void-ensure-system-package-on-load (package &rest system-packages)
  )
...
#+begin_src emacs-lisp
(void-load-on-call 'keychord :before (list #'))
#+end_src
