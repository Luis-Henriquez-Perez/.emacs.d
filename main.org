...
we need them--just in time. And by "just in time" I mean at the last possible moment
...
#+begin_src emacs-lisp
(alet (list #'switch-to-buffer #'find-file)
  (void-load-before-call 'autorevert it))
#+end_src
