...
Furthermore, this could interfere with the loading of other things.
...
(define-key! (emacs insert) ivy-minibuffer-map "TAB" #'ivy-next-line)
#+end_src
...
*** opening apps                                                      :disabled:
:PROPERTIES:
:ID:       1fddfca6-2cf5-4dc6-869f-b10778c049b8
:END:
