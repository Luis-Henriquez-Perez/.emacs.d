...
I want a shorthand for advices.

#+begin_src emacs-lisp
(defun void-load-on-call (package where functions)
  "Load packages before FUNCTIONS are called."
  (fset ' `(lambda () (require ',package)))
  (void-add-advice () :before nil t))

;; Logic for autoloading is this.
...
*** create alist
:PROPERTIES:
:ID:       efc32e52-25da-4acb-ac86-81834d046ed9
:END:

#+begin_src emacs-lisp
(defun void-alist (&rest key-values)
  ""
  ())
#+end_src
...
:PROPERTIES:
:ID:       c5d9c64c-469e-4452-b3d1-07886a2878ff
:END:

****** init
:PROPERTIES:
:ID:       c89020a2-14e1-4c67-8a23-d2e21567c314
:END:

****** settings
:PROPERTIES:
:ID:       f8000314-ed70-4e8e-a42f-ab4e7fcc82ac
:END:
...
****** initialize
:PROPERTIES:
:ID:       57d71ae1-abbd-4744-8269-5f53c2d2c2f8
:END:
...
start loading. [[helpfn:idle-require-load-break][idle-require-load-break]] is the break between features idle
require loads.
...
***** TODO make idle require use void-log                             :disabled:
:PROPERTIES:
...
***** increase gc-cons-threshold during idle loading                  :disabled:
:PROPERTIES:
...
*** commands
:PROPERTIES:
:ID:       b25171b9-15e2-40b3-9f44-d207d63efab6
:END:
...
*** settings
:PROPERTIES:
:ID:       b6717e75-96a8-415c-9c33-52821476d44c
:END:
...
*** bindings
:PROPERTIES:
:ID:       eaaafeb8-0aa3-4c10-8b9f-6283d4e75e7f
:END:
...
*** commands
:PROPERTIES:
:ID:       9d07b39b-4eea-4ecd-af19-b452ede30088
:END:
...
#+begin_src emacs-lisp
(void-autoload 'transpose-frame
               (list #'transpose-frame
                     #'flip-frame
                     #'flop-frame
                     #'rotate-frame
...
*** init
:PROPERTIES:
:ID:       cc51646a-ab29-4544-ae69-5968d43491a3
:END:
...
*** settings
:PROPERTIES:
:ID:       d99af013-45ac-454c-bac5-3970b287d5e6
:END:
...
**** init
:PROPERTIES:
:ID:       4a32b503-c39d-4030-8c6e-d391ef101772
:END:
...
;; (void-autoload 'orderless
;;                (list #'orderless-filter #'orderless-highlight-matches))
#+end_src
...
#+begin_src emacs-lisp
(void-system-ensure-package 'emms)
(use-package! emms
  :system-ensure mpv
...
#+begin_src emacs-lisp
(--each (list #'hs-minor-mode #'hs-toggle-hiding #'hs-already-hidden-p)
  (void-load-on-call 'hideshow it))
#+end_src
...
**** init
:PROPERTIES:
:ID:       fc23d1b2-c174-4159-bb3f-e63895fb100f
:END:
...
#+begin_src emacs-lisp
(void-autoload 'powerthesaurus
               (list #'powerthesaurus-lookup-word-at-point
                     #'power-thesaurus-lookup-word-dwim))
#+end_src

*** define-it
:PROPERTIES:
:ID:       97a0e6f4-3f38-495e-9dd9-3b518676de2a
:END:
...
#+begin_src emacs-lisp
(--each (list #'evil-insert-state #'evil-emacs-state)
  (void-load-before-call 'keychord it))
;; (void-load-before-call 'keychord
;;                        (list #'evil-insert-state #'evil-emacs-state))
#+end_src
...
**** load before
:PROPERTIES:
:ID:       d36e9447-2134-49cb-973d-c3a8c695f8ac
:END:

#+begin_src emacs-lisp
(void-load-on-call :before 'undo-tree)
#+end_src
...
** autorevert
:PROPERTIES:
:ID:       6655c984-3528-4f02-b2ef-1899063ae434
:END:

*** init
:PROPERTIES:
:ID:       85fbb390-41b0-474b-b529-922c802b1384
:END:

#+begin_src emacs-lisp
(void-load-on-call :after (list #'switch-to-buffer #'find-file))
#+end_src

*** maybe
:PROPERTIES:
:ID:       ea240e46-3980-4ea0-b94f-8496033eceaf
:END:
