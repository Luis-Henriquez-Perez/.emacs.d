...
Note that [[helpfn:help-function-arglist][help-function-arglist]] returns =t= when it fails.
...
#+begin_src emacs-lisp
(after! selectrum
  (defadvice! dont-sort-with-selectrum (:around void/swiper void/set-font)
...
(define-leader-key!
  ...
  "k" (list :def #'org-capture               :wk "capture"))
...
(define-leader-key!
  :infix "s"
  :keymaps 'org-mode-map
  "h" (list :def #'void/swiper :wk "headlines"))
#+end_src
