...
:PROPERTIES:
:ID:       4b6e2892-e242-44e6-87f9-02e030eb6205
:END:

#+begin_src emacs-lisp
(defmacro edefun! (&rest args)
  (declare (indent defun))
  `(eval-and-compile (defun ,@args)))
#+end_src
...
#+begin_src emacs-lisp
(edefun! straight:install-fn (recipe)
  "Function that."
...
#+begin_src emacs-lisp
(edefun! void-property-string-to-plist (string)
...
#+begin_src emacs-lisp
(defvar void-package-recipes (eval-when-compile (void-get-package-recipes))
  "Package recipes.")
