...
(use-package! web-search
  :commands web-search
  :config
  ;; add qwant as a provider
  (prepend! web-search-default-provider
    )
  ;; don't use thing at point
  (defadvice! dont-use-what-I-have-at-point (:around web-search)
    (cl-letf (((symbol-function #'current-word) #'ignore))
      (apply <orig-fn> <args>)))
  :setq
...
(define-leader-key!
  ...
  "q" (list :def #'web-search               :wk "browse web")
  "c" (list :def #'org-capture              :wk "capture"))

(define-leader-key! "s" (list :ignore nil :wk "screenshot"))
