...
code. Well, not so much =VOID-MAIN-ORG-FILE= and =VOID-TODO-FILE= but the others are
referenced alot.
...
[[https://github.com.cnpmjs.org/jwiegley][John Wiegley]], one of Emacs's maintainers, has managed his email for over
...
There are three screenshot packages I know of [[][screenshot]], [[https://github.com/dakra/scrot.el][scrot]] and
[[][]]. But they all have their downsides. Screenshot. Scrot. escr.

*** take screenshot
:PROPERTIES:
:ID:       59a326d7-6199-4e34-b5e1-8c3cb0128232
:END:

#+begin_src emacs-lisp
(defun void--screenshot (geometry image-name &rest args)
  "Take a screenshot of area."
  (let [(x y height width) geometry]
    (call-process-shell-command
     "maim" nil nil nil
     "--geometry" (format "%dx%d+%d+%d" width height x y)
     image-name)))
#+end_src

*** screenshot-filename
:PROPERTIES:
:ID:       1327940f-49ff-4a5a-8623-166bbc426967
:END:

#+begin_src emacs-lisp
(defun void--screenshot-filename ()
  "Return file name for screenshot."
  (alet (filename (read-string "Image name: " (format-time-string "-%Y-%m-%d")))))
#+end_src

*** use current window
:PROPERTIES:
:ID:       04f42f4f-40e2-4376-82e7-5dad06bfdb1d
:END:

From checking out [[][scrot]], I learned how to specify.

#+begin_src emacs-lisp
(defun void/screenshot-current-window ()
  "Take a screenshot of the current Emacs window."
  (interactive)
  (void--screenshot (window-pixel-edges) (void--screenshot-filename)))
#+end_src

*** use current frame
:PROPERTIES:
:ID:       a92cd2f2-78a7-4a5a-83f5-a6877d22e99d
:END:

#+begin_src emacs-lisp
(defun void/screenshot-current-frame ()
  "Take a screenshot of the current Emacs frame"
  (interactive)
