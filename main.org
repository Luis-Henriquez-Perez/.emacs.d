...
** workspaces
:PROPERTIES:
:ID:       b5093cc3-b6fd-41b5-b9d0-cb0a38cd369f
:END:

*** workgroups
:PROPERTIES:
:ID:       dd0f2eb0-1d88-4690-ac5d-5e965f380a31
:END:

#+begin_src emacs-lisp
(use-package! workgroups2
  :commands workgroups-mode
  :init (advice-add #'wg-change-modeline :override #'ignore)
  :pre-setq
  (wg-mode-line-display-on . nil)
  (wg-flag-modified . nil)
  (wg-session-file . (concat VOID-DATA-DIR "wg-session"))
  :setq
