...
#+begin_src emacs-lisp
(after! selectrum
  (defadvice! dont-sort-with-selectrum (:around void/swiper void/set-font void/switch-buffer)
...
#+begin_src emacs-lisp
(defvar void:swiper-history nil "Submission history for `selectrum-swiper'.")
...
#+begin_src emacs-lisp
(defun void/org-outline-headings ()
...
(define-leader-key!
  ...
  "s" (list :def #'void/swiper :wk "swiper")
  "w" (list :def #'search-web/default-engine :wk "web"))

(define-leader-key!
  :infix "s"
  :keymaps 'org-mode-map
  "h" (list :def #'void/org-outline-headings :wk "headlines"))
#+end_src
