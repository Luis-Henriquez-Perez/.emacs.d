...
*** defun!
:PROPERTIES:
:ID:       21c8e809-6c8f-4118-9de7-fae8491081e7
:END:
...
** essential bindings
:PROPERTIES:
:ID:       35dea311-fc84-4913-ac49-762cc316a611
:END:
...
These keybindings are for opening particular apps.

#+begin_src emacs-lisp
(define-leader-key! "f" (list :ignore t :wk "fast"))
...
(define-leader-key! "fs" (list :ignore nil :wk "screenshot"))
...
** org mode
:PROPERTIES:
:ID:       f27e7e3a-9206-4733-adc7-de05f3be9663
:END:

*** traversal
:PROPERTIES:
:ID:       4a361ca2-d16c-46be-a4d6-0d3f2bc3a1cf
:END:
