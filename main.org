...
*** search the web
:PROPERTIES:
:ID:       45afdf5f-81dc-460c-b123-54af07d5eca4
:END:

#+begin_src emacs-lisp
(define-leader-key! :infix "s"
  "w" (list :def #'web-search :wk "web search"))
#+end_src

*** switch theme
:PROPERTIES:
:ID:       d63f1552-d329-4b9d-b6f9-bd22929a33fb
:END:

*** change font
:PROPERTIES:
:ID:       75822f13-1935-4aa7-a9b9-6d624a808fce
:END:

** minibuffer
:PROPERTIES:
:ID:       9fca022e-94fc-4acd-a125-a3d9eccb1c5f
:END:

*** ivy
:PROPERTIES:
:ID:       a91b770e-541d-4fee-8e21-fbf8a5f79f66
:END:

*** selectrum
:PROPERTIES:
:ID:       1b263c72-944d-472c-9f3c-b7d2c13f50e9
:END:
...
(define-leader-key!
  ...
  "q" (list :def #'browse-url               :wk "browse web")
  "c" (list :def #'org-capture              :wk "capture"))
#+end_src
