...
I had been byte-compiling improperly.  So I need to eliminate a few warnings
still.
...
** DONE use =trace!= for some hooks because they are polluting the log
CLOSED: [2025-02-11 Tue 22:33]
** TODO rice up the dashboard
** TODO add a better keybinding for going to evil-marker than =`=
** DONE update auto-insert to create emacs-lisp templates with any file
CLOSED: [2025-02-08 Sat 15:04]
