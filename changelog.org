* Version 0.2
:PROPERTIES:
:ID:       1f815a51-e606-4c36-afa4-435a761f9d27
:END:

** introduction of recipe file
:PROPERTIES:
:ID:       68f724cb-c827-436e-8674-0de6e2172e8a
:END:

=straight.el= provides a lockfile where an alist of the package name and it's
version are stored.

** init heading
:PROPERTIES:
:ID:       b21cd437-e447-4c01-a03b-98f701359a81
:END:

Eventually, I plan to implement more control for the loading of
headlines. Specifically, I want to designate a certain headline name for code
that should be loaded immediately. So for a package headline.
...
** add capture templates and support for them
:PROPERTIES:
:ID:       72c04c33-1eae-47e3-be9d-7b8a2128746a
:END:

Capture templates are one of the simplest yet most powerful features of org
mode. It is the one thing that I feel that all emacsers should utilize heavily
all the time. The purpose of this change is to.

** use system packages
:PROPERTIES:
:ID:       9a9774e3-cad0-4ff4-a4be-73897f105da9
:END:

Many packages require certain other packages to work such as magit. The purpose
