...
The purpose of this change is to establish a concise and consistent standard for
naming an advice function.
...
redundant. This is especially the case with [[][around advice]] whose arguments
...
*** define a consistent syntax
:PROPERTIES:
:ID:       70d49b15-1f0d-4c5c-a1b5-a333ed5adb31
:END:

Now advices have a consistent syntax.
Before this change advices had different syntax. Influenced by [[][Doom's advice
syntax]], I would end many of my advices with an =-a=. However, partly because I
was unsure whether Doom's syntax was the best choice, I did so inconsistently.
Now, all user-defined advices.
...
*** syntax
:PROPERTIES:
:ID:       1e490fef-0d3f-491c-b1e3-8b0ba2d5e131
:END:

#+begin_src emacs-lisp
(defadvice! do-what-i-actually-want (:after some-function)
  ""
  (+ 1 1))
#+end_src
