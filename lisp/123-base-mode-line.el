...
(autoload! all-the-icons-icon-for-buffer "all-the-icons")
(autoload! all-the-icons-faicon "all-the-icons")
(autoload! nerd-icons-wicon "nerd-icons")
(autoload! nerd-icons-pomicon "nerd-icons")
...
(autoload! nerd-icons-powerline "nerd-icons")
