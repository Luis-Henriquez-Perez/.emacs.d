;;; init-pkg-package.el --- Initialize package -*- lexical-binding: t; -*-
;;
...
;;                                      (meep :url "https://codeberg.org/luishp/emacs-meep" :branch "my-used-branch")
...
;;; provide
(provide 'init-pkg-package)
;;; init-pkg-package.el ends here
