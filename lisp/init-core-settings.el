;;; init-core-settings.el --- core settings -*- lexical-binding: t; -*-
;;
...
(o-opt window-divider-default-bottom-width 7)
(o-opt window-divider-default-right-width 7)
(o-opt window-divider-default-places t)
;;;; TRASH
