...
(define-abbrev-table 'emacs-lisp-mode-abbrev-table
  '(("aih" "after-init-hook")
    ("dfn" "" tempel|expand-elisp-defun :enable-function abbrev|in-elisp-code-p)
    ("dhk" "" tempel|expand-elisp-defhook :enable-function abbrev|in-elisp-code-p)
    ("dvar" "" tempel|expand-elisp-defvar :enable-function abbrev|in-elisp-code-p)
    ("elasped" "elapsed")
    ("esh" "emacs-startup-hook")
    ("funn" "" tempel|expand-elisp-defun :enable-function abbrev|in-elisp-code-p)
    ("msg" "" tempel|expand-elisp-message :enable-function abbrev|in-elisp-code-p)
    ("msgv" "" tempel|expand-elisp-message-var :enable-function abbrev|in-elisp-code-p)))
;;; provide
