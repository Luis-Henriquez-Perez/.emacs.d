...
(bind! oo-leader-map "k" #'oo-org-prefix-command :wk "org")
(bind! oo-leader-map "l" #'oo-org-prefix-command :wk "org")

(bind! oo-org-map "k k" #'+org-capture-todo)
...
(bind! oo-org-map "k j" #'+org-capture-todo)
(bind! oo-org-map "k t" #'+org-capture-todo)
(bind! oo-org-map "k k" #'+org-capture-bug)
(bind! oo-org-map "k ;" #'+org-capture-question)
(bind! oo-org-map "k q" #'+org-capture-question)
;;;;; app
