...
(bind! oo-leader-map "b" #'oo-buffer-prefix-command "buffer")
(bind! oo-leader-map "g" #'oo-git-prefix-command "git")
(bind! oo-leader-map "l" #'oo-git-prefix-command "git")
(bind! oo-leader-map "w" #'oo-window-prefix-command "window")
(bind! oo-leader-map "a" #'oo-app-prefix-command "app")
(bind! oo-leader-map "p" #'oo-package-prefix-command "package")
(bind! oo-leader-map "f" #'oo-find-prefix-command "find")
(bind! oo-leader-map "h" #'oo-help-prefix-command "help")
(bind! oo-leader-map "e" #'oo-emms-prefix-command "emms")
(bind! oo-leader-map "t" #'oo-toggle-prefix-command "toggle")
(bind! oo-leader-map "q" #'oo-quit-prefix-command "quit")
;;;;; window
