...
;;;; autoload commands
(declare-function! oo-open-emacs-config "989-commands")
(declare-function! oo-open-emacs-init-file "989-commands")
(declare-function! oo-open-emacs-lisp-dir "989-commands")
(declare-function! oo-split-window-below-and-focus "989-commands")
(declare-function! oo-split-window-right-and-focus "989-commands")
(declare-function! oo-set-font-face "989-commands")
(declare-function! oo-dwim-space "989-commands")
(declare-function! oo-dwim-narrow "989-commands")
(declare-function! oo-pop-to-buffer "989-commands")
(declare-function! oo-dwim-align "989-commands")
(declare-function! oo-kill-emacs-no-confirm "989-commands")
(declare-function! oo-new-buffer "989-commands")
(declare-function! oo-load-random-theme "989-commands")
(declare-function! oo-sort-dwim "989-commands")
(declare-function! oo-startup-time-table "989-commands")
(declare-function! oo-one-line "989-commands")
(declare-function! oo-remove-consequtive-spaces "989-commands")
(declare-function! oo-open-emacs-lisp-dir "989-commands")
(declare-function! oo-dwim-vc-action "989-commands")
;;;; xref
