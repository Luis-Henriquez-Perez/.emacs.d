...
(eshell/alias "ecompile" "emacs --batch --eval \"(load \\\"~/.config/emacs/init.el\\\")\" -f batch-byte-compile ~/.config/emacs/init.el ~/.config/emacs/early-init.el ~/.config/emacs/lisp/*.el")
