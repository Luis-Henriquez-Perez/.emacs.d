...
;; (defun o--left-bouned-by-space-p ())
;; (defun o--skip-ov-fn (motion-fn)
;;   "Return MOTION-FUNCTION."
;;   (o-before-fn motion-fn (apply-partially #'goto-char (end-of-overlay)))
;;   (o-if-fn #'in-overlay-p it motion-function))
;;;; set the evilem-keys
