;;; init-pkg-dirvish.el --- Initialize dirvish -*- lexical-binding: t; -*-
;;
...
(o-defer-load-after 'dired (apply-partially #'require 'nerd-icons))
...
(o-opt dirvish-mode-line-format nil)
;;; provide
(provide 'init-pkg-dirvish)
;;; init-pkg-dirvish.el ends here
