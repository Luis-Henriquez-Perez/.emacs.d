;;; init-after-org.el --- Configure nil -*- lexical-binding: t; -*-
;;
...
;;;;; ORG-CAPTURE
(autoload 'org-capture|plain "init-after-org-capture" nil nil 'function)
(autoload 'org-capture|todo "init-after-org-capture" nil nil 'function)
(autoload 'org-capture|open "init-after-org-capture" nil nil 'function)
(autoload 'org-capture|question "init-after-org-capture" nil nil 'function)
(autoload 'org-capture|bug "init-after-org-capture" nil nil 'function)
(autoload 'org-capture|choose-template "init-after-org-capture" nil nil 'function)

(o-remap-alt 'org-capture #'org-capture #'org-capture|choose-template)

(o-call-after-load 'org-capture 'init-after-org-capture)
;;;;; ORG-REFILE
...
;;; provide
(provide 'init-after-org)
;;; init-after-org.el ends here
