...
#+begin_src emacs-lisp
(setq use-package-keywords
      (+use-package-insert-keyword 'after :ensure :built-in))

(+use-package-defnormalize! built-in ()
...
#+begin_src emacs-lisp
(defhook! enable-org-tempo-templates (org:description-edit-mode-hook)
  (tempo-use-tag-list 'tempo:org-mode-taglist))

(xl-add-hook 'org:description-edit-mode-hook #'company-mode)

;; Add an element to the company alist.
(after! company
  (push '(org:description-edit-mode :only (company-tempo)) company:backend-alist))
#+end_src
...
(defsnippet! helpvar ("hvar" org-mode)
  "Help function link."
  `("[[helpvar:" (C var "variable: " ,obarray helpful--variable-p) "][" (s var) "]]"))#+end_src
