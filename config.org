...
**** init
:PROPERTIES:
:ID:       19c03205-f56e-4e3b-b258-181d67abaa25
:END:
...
can define a template using a lisp form as opposed to a string.

**** tempo snippet
:PROPERTIES:
:ID:       d11c9cc1-f2e7-4ae0-8e54-696f1b41f028
:END:

=tempo-snippet= is a package that provides a macro.

**** tempo-x
:PROPERTIES:
:ID:       88883a78-91cd-4540-a966-71995e52a351
:END:

=tempo-x= provides extensions for tempo.

**** company backend for tempo
:PROPERTIES:
:ID:       9b3358ea-0713-4da6-83cb-9c566d97dc32
:END:

I want tempo snippets to show up for company.
