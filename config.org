...
#+begin_src emacs-lisp
(defconst VOID-RECIPE-FILE (concat VOID-EMACS-DIR "recipes.org")
...
(setq straight-repo-dir (concat straight-base-dir VOID-PACKAGES-DIR))
...
**** initialize straight
:PROPERTIES:
:ID:       9011497f-098d-4d7d-b4fc-a816f121f23b
:END:
...
(defun straight:revision (package)
  ...
  (straight--with-plist (hash-get (symbol-name package) straight--recipe-cache)
      (local-repo type)
...
**** freeze versions
:PROPERTIES:
:ID:       f2e8dab3-690c-4efd-9c04-6109d310ac18
:END:

#+begin_src emacs-lisp
(defun void-freeze-versions ()
  "")
#+end_src

*** package installation
:PROPERTIES:
:ID:       350ebc50-cb45-43c3-994a-754658110ea4
:END:
...
#+begin_src emacs-lisp
(mapc #'straight-use-package (void-package-recipes))
#+end_src
...
*** auto-yasnippet
:PROPERTIES:
:ID:       21fad08d-485b-4498-b47b-571cc48e5384
:RECIPE:   [[id:7238d32e-4a73-4aff-80e1-ce6f1629b926][auto-yasnippet]]
:END:
...
:RECIPE:   [[id:c2d2579c-351b-4bb8-b5a1-4b7040ecefd4][yasnippet]]
:END:
...
:PROPERTIES:
:ID:       e09b0485-e57b-471b-abb0-86eda545efd0
:END:
