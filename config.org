...
(defun void-init-straight ()
  ...
  (let* ((straight-base-dir straight-base-dir)
    ...
    (unless (file-exists-p bootstrap-file)
      (make-directory straight-repo-dir)
      (shell-command (format "git -C %s clone https://github.com/raxod502/straight.el.git"))
      (shell-command (format "git -C %s checkout %s"
			     (plist-get (alist-get 'straight void-recipe-list) :commit))))
