...
(defun uuse-package-normalize-cons (cons-pair)
  (loopy ((list car (-list (car cons-pair)))
	  (collect (cons car (cdr cons-pair))))))
...
(uuse-package-defnormalize! xl-hook ()
  ...
  (->> <args>
       ...
       (--map (cons (xl-hookify-symbol (car it)) (cdr it)))))
...
(uuse-package-defnormalize! xl-before-call ()
  (cl-assert (-all-p (-orfn #'symbolp #'-cons-pair-p) <args>))
  (->> <args>
       (--map-when (symbolp it) (cons it <name>))
       (-mapcat #'uuse-package-normalize-cons)))
...
#+begin_src emacs-lisp
(config-package! company :general
...
#+begin_src emacs-lisp
(config-package! company-prescient :hook company-mode-hook)
#+end_src
...
#+begin_src emacs-lisp
(config-package! expand-region :config
...
#+begin_src emacs-lisp
(config-package! lispyville :hook emacs-lisp-mode-hook)
#+end_src
