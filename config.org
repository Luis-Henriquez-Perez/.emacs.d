...
** yadm integraton
:PROPERTIES:
:ID:       ab5bf5e2-bfc6-45e9-9427-818f2f8d8ce7
:END:
...
(alet '("yadm"
  ...
  (push it tramp-methods))

(defun magit/yadm-status ()
  "Use yadm status."
  (interactive)
  (require 'tramp)
  (magit-status  "/yadm::"))
...
**** save things typed into the eshell buffer
:PROPERTIES:
:ID:       ba7e682d-2f6b-4fc2-8197-0906e9e9ce41
:END:

I want to know what I did in the eshell buffer.
