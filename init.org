...
(defconst VOID-INIT-EL-FILE (concat VOID:EMACS-DIR "init.el")
  "Path to the elisp file that bootstraps Void startup.")

(defconst VOID-INIT-ORG-FILE (concat VOID:EMAIL-DIR "init.org")
...
(defun void/switch-to-init-org-file ()
  (interactive)
  (find-file (concat VOID:EMACS-DIR "init.org")))
#+end_src
...
(defun void/switch-to-init-org-file ()
  ...
  (interactive)
  (switch-to-buffer VOID-INIT-EL-FILE))
#+end_src
...
because ~VOID-INIT-EL-FILE~ already contains all the code I need so I don't want it
