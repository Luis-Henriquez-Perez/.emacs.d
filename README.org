...
#+begin_src emacs-lisp
(def-package screenshot :commands screenshot)
#+end_src
...
#+begin_src emacs-lisp
(def-package ialign :commands ialign)
#+end_src
...
#+begin_src emacs-lisp
(def-package restart-emacs :commands restart-emacs)
#+end_src
...
#+begin_src emacs-lisp
(def-package git-gutter :commands git-gutter-mode)
#+end_src
...
#+begin_src emacs-lisp
(def-package sudo-edit :commands sudo-edit)
#+end_src
...
#+begin_src emacs-lisp
(def-package cider :commands cider)
#+end_src
