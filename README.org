...
(defmacro defmacro! (name args &rest body)
  ...
  (-let [(docstring alist body) (void--keyword-macro-args body)]
    `(defmacro ,name ,args
       ,docstring
...
***** syntax highlighting
:PROPERTIES:
:ID:       0a3778f3-f1f9-40c9-908e-1fe8ab68b08a
:END:

#+begin_src emacs-lisp
(defhook! add-syntax-highlighting-for-defmacro (emacs-lisp-mode-hook)
  "Add"
  ())
#+end_src
  ...
  (let* ((string-name (downcase (symbol-name name)))
    ...
    `(after! org-capture
       ...
       (defun org-capture::<string-name>-template-string ()
         ...
         (->> (org-capture::<string-name>-template-string)
              (org-ml-to-trimmed-string)))
       (->> '(:keys ,key :template #'org-capture::<string-name>-template-string)
