...
#+begin_src emacs-lisp
(defun use-package-normalize/:hook@abbrev-hooks-and-modes (name keyword args)
  args)

(advice-add #'use-package-normalize/:hook :override #'use-package-normalize/:hook@abbrev-hooks-and-modes)
#+end_src
...
#+begin_src emacs-lisp
(defun use-package-handler/:hook@use-void-add-hook (name keyword args rest state)
  (use-package-concat
   (use-package-process-keywords name rest state)
   (list args)))

(advice-add #'use-package-handler/:hook :override #'use-package-handler/:hook@use-void-add-hook)
#+end_src
