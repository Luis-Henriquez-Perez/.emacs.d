...
=defpackage!= is to make adding new keywords as easy and straightforward as
...
(defun def-package-normalize-args (args)
  ...
  (->> (-partition-by-header #'keywordp args)
       (sort #'def-package-sort-by-weight)
...
constructed by the =defpackage!= macro. Often there is some metadata that is
...
want in the resulting =defpackage!= form and adding it to to the [[helpfn:][]].
...
(defmacro def-package-key! (name args &rest body)
  "Define a `defpackage!' keyword named NAME.
...
(push (cons :setq #'def-package-ensure-form-list))
#+end_src
...
#+begin_src emacs-lisp
(def-package-key! commands (command)
...
#+begin_src emacs-lisp
(defpackage! dash-functional :require t)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! keyfreq :hook emacs-startup-hook)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! exec-path-from-shell
  :os mac
...
#+begin_src emacs-lisp
(defpackage! exwm-edit :after exwm)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! counsel-org-capture-string
  :after org ivy
...
#+begin_src emacs-lisp
(defpackage! company-prescient :hook company-mode-hook)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! screenshot :commands screenshot)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! scrot :ensure (:host github :repo "dakra/scrot.el"))
#+end_src
...
#+begin_src emacs-lisp
(defpackage! highlight-escape-sequences
...
#+begin_src emacs-lisp
(defpackage! org-link-minor-mode
...
#+begin_src emacs-lisp
(defpackage! aggressive-indent :hook emacs-lisp-mode-hook)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! ialign :commands ialign)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! aggressive-fill-paragraph)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! evil-surround :hook prog-mode-hook text-mode-hook)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! evil-matchit :hook prog-mode)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! all-the-icons-dired :hook ranger-mode-hook)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! restart-emacs :commands restart-emacs)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! git-gutter :commands git-gutter-mode)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! sudo-edit :commands sudo-edit)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! cider :commands cider)
#+end_src
...
#+begin_src emacs-lisp
(defpackage! markdown-mode :mode "\\.md\\'")
#+end_src
...
#+begin_src emacs-lisp
(defpackage! org-fancy-priorities
  :hook org-mode-hook
  :setq
...
#+begin_src emacs-lisp
(defpackage! modern-cpp-font-lock
