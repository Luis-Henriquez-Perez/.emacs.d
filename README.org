...
***** whether a keyword
:PROPERTIES:
:ID:       c075a57b-9e68-4e86-9166-6314a8468fe4
:END:

#+begin_src emacs-lisp
(if (and (symbolp it)
         (s-matches-p "<\\([^[:space:]]+\\)>" (symbol-name it)))
    (void--anaphoric-format it)
  it)
#+end_src
...
#+begin_src emacs-lisp
(cl-defun void--anaphoric-format (symbol)
  "Return the form that will replace."
  (let* ((string (symbol-name symbol))
         (regexp (rx "<" (group (1+ (not (any white)))) ">"))
