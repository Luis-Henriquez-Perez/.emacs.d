...
**** requirement
:PROPERTIES:
:ID:       d7a833af-2873-480e-bffb-f1f154331c95
:END:
...
(defmacro use-package! (package &rest args)
  ...
  `(use-package ,package
     ...
     ,(map-merge 'plist args use-package:defaults)
...
#+begin_src emacs-lisp
(setq use-package-keywords
      (--splice (eq :hook it) (list :hook it) use-package-keywords))
#+end_src
