...
As I've mentioned, querying is a huge part of our workflow. Traversing the
jungle of candidates.
...
query to narrow the list, and then selecting one of the remaining candidates. [[][]] is an example.
...
There are certain commands that should not be sorted.
...
This package lets me websearch.
