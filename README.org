...
*** committing
:PROPERTIES:
:ID:       f1d66266-d3e3-41e4-8790-a8ea1e7d7a1f
:END:
...
easy to go back and group commits which are related.
...
(defadvice! properly-unfold-surrounding-headlines (:around counsel-org-goto-action)
  "Properly unfold nearby headlines and reveal current headline if it is folded."
