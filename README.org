...
Theme:ef-light Font: recursive mono
...
:END:
  ...
  This means adding the lisp directory to the load-path, directly or indirectly
  load all needed files and set up necessary initial variables.  This is the "big
  bang" that sets everything else into motion.
