...
These bindings are partially influenced by some of helm's minibuffer bindings.
...
they are filtered in real time. [[https://github.com/raxod502/prescient.el][ivy-prescient]]
...
This function allows you to toggle marking a candidate.
...
***** icons
:PROPERTIES:
:ID:       c6269c07-0807-469a-bf22-f1864c1586fd
:END:
...
Counsel is a library of convenience functions that build on top of ivy.
...
convenience functions are just wrappers around existing emacs functions that provide.

#+begin_src emacs-lisp
(general-def '(emacs insert) counsel-mode-map
...
There are certain commands that should.
...
[[https://github.com/abo-abo/swiper][Swiper]] is a package that lets you interactively search text in a buffer.
