...
**** enable markup completion for org mode
:PROPERTIES:
:ID:       c89cb9d1-b6ad-49dc-93ff-b70bc8511e87
:END:

#+begin_src emacs-lisp
(defhook! enable-auto-markup-pairing (org-mode-hook)
  "Enable auto-pairing with org mode markup delimiters."
  (sp-local-pair 'org-mode "=")
  (sp-local-pair 'org-mode "*")
  (sp-local-pair 'org-mode "/")
  (sp-local-pair 'org-mode "_"))
#+end_src

**** elisp mode pairing
:PROPERTIES:
:ID:       8704c884-87e4-4590-8599-3cf92b826aff
:END:

#+begin_src emacs-lisp
(defhook! enable-elisp-pair (emacs-lisp-mode)
  "Enable pairing of `emacs-lisp-mode' delimiters."
