...
#+begin_src emacs-lisp
(defun leaf~insert-after (plist key targetlist)
  "Insert TARGETLIST."
  (let ((place (+ 2 (-elem-index key plist))))
    (--each targetplist
      (setq plist (-insert-at place it plist))
      (++ place))
    plist))
#+end_src
...
#+begin_src emacs-lisp
(defun leaf~insert-at (list elem targetlist)
