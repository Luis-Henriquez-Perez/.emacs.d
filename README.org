...
:END:
- *fast startup* Startup should be as fast as possible by which I mean less than a
  second.  I currently have a startup time of =0.74= seconds (this is with
  byte-compilation).
- *performant*
  Furthermore, the experience while using emacs should be responsive fast and
  snappy.  As of this version my Emacs startup time is consistently less than a
  second, fluctuating between =0.74= and =0.97= seconds.
- *introspectable*
  ...
  this end I fashion [[lisp/001-init-log.el][my own logger]].
- *expressive*
...
- Spacemacs-like [[file:lisp/160-keybindings.el][keybinding scheme]]
...
:END:
  ...
  - *lisp/xxx-keybindings.el* - /Store all of my keybindings./
