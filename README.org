...
This function is for convenience and side-effect.
...
**** bind preprecessor
:PROPERTIES:
:ID:       9b087a90-f8ca-425a-aec3-0d9a1c82cf2a
:END:
...
**** preprocess fn
:PROPERTIES:
:ID:       fb3ada26-d3c8-427a-b449-3d851c9413f0
:END:

#+begin_src emacs-lisp
(defun leaf~pre-process (key value)
  "Return a cons cell with key as cdr."
  (cons key (funcall (alist-get key ))))
#+end_src

**** e
:PROPERTIES:
:ID:       510ce24d-3401-458c-aab5-2f37eb13ba4f
:END:
...
#+begin_src emacs-lisp
(defun leaf~flatten-keywords (args)
  "Flatten keywords."
  (->> (-partition-by-header #'keywordp args)
       (--mapcat (-annotate (-const (car it)) (cdr it)))
       (-map #'-cons-to-list)
       (-flatten-n 1)
...
#+begin_src emacs-lisp
(defleaf! vsetq (before setq (var . value))
  `(setq ,var ,value))
#+end_src
