...
- *performant*
  ...
  snappy.  As of this version, ~(emacs-init-time)~ is "0.74 seconds" without
  compilation.
- *introspectable*
...
:END:
  ...
  - *lisp/oo-init* - /Some file I use but do not know what to do with yet./
