...
stock autosaving. Notably it allows the specification of which files to try to
save and not to save in [[helpvar:auto-save-buffers-enhanced-include-regexp][auto-save-buffers-enhanced-include-regexp]] and
[[helpvar:auto-save-buffers-enhanced-exclude-regexp][auto-save-buffers-enhanced-exclude-regexp]].

#+begin_src emacs-lisp
(defhook! enable-enhanced-auto-saving (void:after-switch-buffer-hook)
  "Enable enhanced auto-saving."
  (require 'auto-save-buffers-enhancd)
  (auto-save-buffers-enhanced t)
  (remove-hook 'void:after-switch-buffer-hook
               #'void:after-switch-buffer-hook&enable-enhanced-auto-saving))
...
(use-package! auto-save-buffers-enhanced
  ...
  (auto-save-buffers-enhanced-include-regexps . (list (rx (1+ anything)))))
#+end_src

** autosave-focus
:PROPERTIES:
:ID:       30fda27e-dd3b-4d3d-98f0-658be6e94d09
:END:

[[][autosave-focus]] is a package that provides modes to save modified buffers
...
This package saves buffers during idle time and after certain commands.
