...
file being saved. Instead of doing this, this package saves buffers during idle
...
Note that this is the same strategy employed by [[][idle-require]] to load packages.
