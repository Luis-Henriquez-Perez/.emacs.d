...
Also allow for arguments to be added bellow the docstring."
  (let ((hook (car args))
    ...
    `(progn
       ,(when hooks
          `(defhook! ,name ,(append hooks specs keyword-args)
             ,docstring
             ,@body))
       (defhook ,name ,(cons hook (append specs keyword-args))
         ,docstring
         ,@body))))
#+end_src
...
#+begin_src emacs-lisp
(defadvice! overwrite-hook-done-message (fn hook &rest _)
...
#+begin_src emacs-lisp
(defadvice! overwrite-hook-executed-message (fn hook &rest _)
...
***** hook name
:PROPERTIES:
:ID:       b3dcd195-e64f-4055-850f-4cb159895888
:END:

***** add-hook
:PROPERTIES:
:ID:       fea86ba0-d836-4c58-97cc-97718918922f
:END:

#+begin_src emacs-lisp
(defun void:add-hook (targets hooks &optional depth)
  "Add a hook."
  )
#+end_src
