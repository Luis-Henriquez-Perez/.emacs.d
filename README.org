...
(defmacro defleaf! (name args &rest body)
  ...
  (-let* (((where place alias defer normalizer) args)
    ...
    `(progn
       (leaf~insert-keyword ,keyword ,where ,place ',body)

       ,@(-map (-partial #'leaf~set-alias keyword) (-list alias))
...
#+begin_src emacs-lisp
(defleaf! defer (replace leaf-defer :leaf-defer)
