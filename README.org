...
:END:
  ...
  allowing me to write declarative, straightforward code in each file as opposed
  to code encased with [[/home/luis/.config/documentation/29.4-helpful--eval-after-load.html][eval-after-load]].
