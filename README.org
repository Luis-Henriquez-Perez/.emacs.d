...
save and not to save in [[helpvar:auto-save-buffers-enhanced-include-regexp][auto-save-buffers-enhanced-include-regexp]] and [[helpvar:auto-save-buffers-enhanced-exclude-regexp][auto-save-buffers-enhanced-exclude-regexp]].
