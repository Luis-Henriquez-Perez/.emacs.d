...
This package doesn't see exwm application windows. You just get a [[image:./screenshots/black-window-on-top-should-be-iceweasel.png]][black window]]
...
When I use scrot exwm windows don't show anymore.
