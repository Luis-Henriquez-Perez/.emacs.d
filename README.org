...
In this headline, the things that will do.
...
(defmacro use-package! (package &rest args)
  `(use-package ,package
     ,@(-replace-where #'keywordp #'use-package:true-key args)))
#+end_src
...
**** use-feature!
:PROPERTIES:
:ID:       4b9e7bc4-4e22-4e81-bef0-99b78bc8befd
:END:
...
#+begin_src emacs-lisp
(defvar use-package:aliases '((:hook . :vhook) (:ensure . :straight))
