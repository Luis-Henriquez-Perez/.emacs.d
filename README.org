...
BODY contains any number of `<NAME>' where NAME refers to the name of the symbol."
  ...
  (let* ((symbols (->> (flatten-list body)
                       (-select #'void-anaphoric-symbol-p)
                       (-uniq)))
...
*** selectrum                                                         :disabled:
:PROPERTIES:
:ID:       06f3ca3b-3af5-46c7-8978-978b752942d1
:END:

**** selectrum
:PROPERTIES:
:ID:       1c8a1295-d74c-43a2-b1af-fe54eac5d5ff
:END:
...
**** selectrum prescient
:PROPERTIES:
:ID:       3e261b91-b0e1-47ec-aeef-3c43c4eded2a
:END:

**** embark
:PROPERTIES:
:ID:       ac9042f8-f9ee-49fe-a871-557c9acaf2d3
:END:
...
*** helm                                                              :disabled:
:PROPERTIES:
:ID:       1b29973a-a6b5-42d2-895c-34974df6fdf4
:END:
...
[[https://github.com/emacsmirror/screenshot.git][screenshot]] is another emacs screenshot package that.
...
Like [[id:c0975eae-c03b-4d2a-a546-06c05197eded][screenshot]], [[https://github.com/dakra/scrot.el][scrot]] is screenshot taking utility. Interestingly, scrot
...
(defun org:todo-keywords ()
  ...
  (--select (and (stringp it) (not (string= "|" it)))
...
upon pressing enter, you execute the command. The fact that this command is
...
(define-leader-key!
  ...
  "w" (list :def #'counsel-search :wk "web")
  "i" (list :def #'helm-info :wk "info"))
