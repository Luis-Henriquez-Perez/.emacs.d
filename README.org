...
(defvar leaf:process-variables
  '(raw name key keyname value body)
...
**** defleaf!
:PROPERTIES:
:ID:       9dbefb72-ac4c-4f5b-aa3d-3a7562b773f3
:END:
...
**** normalize
:PROPERTIES:
:ID:       9ef1bc5f-0491-45b9-8090-982c4ca92179
:END:

#+begin_src emacs-lisp
(defun leaf~normalize-args (plist)
  "Normalizes the keywords in plist form."
  (-partition-by-header #'keywordp plist))
#+end_src
...
**** hook
:PROPERTIES:
:ID:       49918d60-23ef-4c74-bfbb-9a19c7c30092
:END:

#+begin_src emacs-lisp
(defleaf! hook (hook . fn)
  `(void-add-hook ',hook #',fn))
#+end_src
...
(defleaf! after-call (before :hook)
  `(defadvice!))
#+end_src
...
(defleaf! straight (before (recipe) ensure)
  `(straight:install-package ,recipe))
#+end_src
...
#+begin_src emacs-lisp
(defleaf! popup (before buffer-name)
