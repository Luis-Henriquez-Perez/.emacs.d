...
[[][]] is a package that replaces and (as its name suggests) enhances Emacs's
stock autosaving. Some of the differences that stuck out to me.

#+begin_src emacs-lisp
(use-package! auto-save-enhanced
  :setq
  (setq auto-save-buffers-enhanced-interval)
  (setq auto-save-buffers-enhanced-quiet-save-p)
